...
const Project = (project) => {
  return (
    <div className={`pt-16 font-bold ${project.styles} justify-between mt-28 items-center`} id="projects">
      <div className="w-[45%]">
        ...
        <div className="mt-5">
          <a href="#projects" class="inline-block text-lg px-5 py-3 leading-none rounded-lg text-lightBlue border border-lightBlue hover:text-darkBlue hover:bg-white mt-4 lg:mt-0">Live demo</a>
      ...
      <div className="w-[50%] aspect-[3/2] border-[15px] border-lightBlue rounded-lg">
        <img src={about} className="w-[100%] h-[110%] relative left-6 -top-6 rounded-lg" alt="img"/>
      </div>
    </div>
  )
}
